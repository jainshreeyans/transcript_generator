...
class student_info:
    ...
    def create_table(curr_sem,pdf,start_x,start_y,sem,a3):
        ...
        col_width = [21,60,13,13,13] if a3 else [15,50,8,8,8]
    ...
    def create_transcript(self,want_seal):
        ...
        start_x = [left_x+10,left_x+140,left_x+270] if a3 else [left_x+5,left_x+99,left_x+193]
        ...
        for curr_sem in range (len(self.semesters)):
            ...
            student_info.create_table(self.semesters[curr_sem],pdf,start_x[(curr_sem)%3],start_y[(curr_sem)//3],sem_string,a3)
...
start_rno = tkinter.Entry(window)
end_rno = tkinter.Entry(window)
gen_button = tkinter.Button(window,text='Generate All Transcripts',width = 25, command = lambda:create_all_transcript(True))
gen_button.pack()
window.mainloop()